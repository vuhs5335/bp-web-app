...
public final class ApiRequestUpdateException extends Exception {
  public ApiRequestUpdateException (String message) { 
      super(message); 
  } 
  public ApiRequestUpdateException(Exception e) { 
      super(e); 
  } 
  public  ApiRequestUpdateException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

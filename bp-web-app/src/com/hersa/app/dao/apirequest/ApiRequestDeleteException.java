...
public final class ApiRequestDeleteException extends Exception {
  public ApiRequestDeleteException (String message) { 
      super(message); 
  } 
  public ApiRequestDeleteException(Exception e) { 
      super(e); 
  } 
  public  ApiRequestDeleteException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

...
public final class ApiRequestCreateException extends Exception {
  public ApiRequestCreateException (String message) { 
      super(message); 
  } 
  public ApiRequestCreateException(Exception e) { 
      super(e); 
  } 
  public  ApiRequestCreateException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 

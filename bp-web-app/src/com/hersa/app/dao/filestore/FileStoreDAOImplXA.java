...
import com.hersa.app.DefaultConnectionProvider;  
              class FileStoreDAOImplXA extends FileStoreDAOImpl {                                
                  private static final Logger logger =                                             
                      Logger.getLogger(FileStoreDAOImplXA.class);                           
                  private Connection conXA;                                                          
                  FileStoreDAOImplXA() {                                                        
                      super();                                                                 
                      factory = new DefaultConnectionProvider(FileStoreJNDI.XA_DATASOURCE);  
                  }                                                                                
                  public void open() {                                                             
                  ...
                  protected Logger getLogger() {                                                   
                      return FileStoreDAOImplXA.logger;                                     
                  }                                                                                
